    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('admin.events.create') }}" class="px-6 py-2 rounded-xl bg-lava-600 hover:bg-lava-500 text-white font-bold uppercase tracking-widest text-sm shadow-lg shadow-lava-900/50 transition-all hover:scale-105">
                    Create Event
                </a>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-white/5">
                        ...
                        <tr class="hover:bg-white/5 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @else
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-gray-500/20 text-gray-400 border border-gray-500/30">ENDED</span>
                                @endif
                            </td>
