...
@section('title', '500 - Server Error | LAVA ESPORTS')
...
<div class="relative min-h-screen flex items-center justify-center">
    ...
    <div class="relative z-10 text-center px-4 max-w-2xl mx-auto">
        <h1 class="text-[10rem] md:text-[14rem] font-black text-transparent bg-clip-text bg-gradient-to-r from-red-700 via-red-500 to-red-600 font-[Orbitron] leading-none tracking-tighter opacity-90">
            500
        </h1>
