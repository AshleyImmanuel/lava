<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-400 hover:text-lava-400 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lava-500 dark:focus:ring-offset-gray-800 transition-colors" href="{{ route('login') }}">
