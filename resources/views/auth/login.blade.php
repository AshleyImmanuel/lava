<x-guest-layout>
    <div class="text-center mb-8">
        <h1 class="text-3xl font-black text-white font-[Orbitron] mb-3">Welcome Back</h1>
        <p class="text-gray-400">Sign in to continue to LAVA ESPORTS</p>
    </div>
    ...
    <div class="mt-10 text-center">
        <p class="text-gray-500">
            ...
            <a href="{{ route('register') }}" class="text-lava-400 hover:text-lava-300 transition-colors font-bold">Sign up</a>
        </p>
    </div>
</x-guest-layout>
